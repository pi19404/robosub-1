...
int SIZE = 1024, SIZEX = 1024;
int OFFSET_X = -28, OFFSET_Y = 20;    //These offsets are chip specific, and vary.  Play with them to get the best ones for you

void setup() {
  size(SIZEX, SIZE, P3D);
  sp = new Serial(this, "/dev/ttyS1",  9600);
  buff = new byte[128];
  r = new float[3];
}
